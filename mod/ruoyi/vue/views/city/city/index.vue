<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="城市地区id" align="center" prop="id" />
      <el-table-column label="省" align="center" prop="economize" />
...
存储   省，市，县区对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="省" prop="economize">
          <el-input v-model="form.economize" placeholder="请输入省" />
        </el-form-item>
        <el-form-item label="市" prop="city">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除城市存储   省，市，县区编号为"' + ids + '"的数据项？').then(function() {
        return delCity(ids);
      }).then(() => {
        this.getList();
